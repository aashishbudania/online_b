    ...
    <head>
        ...
        <div class='content_customer'>
           ...
           <ul>
              ...
              <li> Admin can add/edit/delete customer . </li>
             <li> Admin and customer can change their password whenever required . </li>
             <li>Admin Login pages are hidden from customer for security purpose.</li>
